...
REQUIRED_FIELDS = [
    "ortsteil", "bezirk", "rooms", "area_m2", "floor", "total_floors",
...
def _build_feature_row(listing: dict, bundle: dict) -> pd.DataFrame:
    ...
    for col in ("position", "bezirk", "transit_line"):
